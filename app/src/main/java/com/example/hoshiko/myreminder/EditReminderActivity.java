...
public class EditReminderActivity  extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRepeatText.setText("Mỗi " + mRepeatNo + " " + mRepeatType + " ");
    ...
    // Hiển thị giờ hiện tại nếu click vào Time picker
    ...
    // Hiển thị ngày hiện tại nếu click vào Time picker
        ...
        switch (item.getItemId()) {
            ...
            case R.id.save_reminder:
                ...
                if (mTitleText.getText().toString().length() == 0)
                    mTitleText.setError("Tiêu đề không được trống !");
            ...
            case R.id.discard_reminder:
                Toast.makeText(getApplicationContext(), "Hủy thay đổi", Toast.LENGTH_SHORT).show();
